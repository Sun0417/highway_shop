...
class Instance extends Component{
    ...
    public function setWeixinjspi_config($config)
    {
        $this->weixinjspi_config = $config;
    }
     ...
     * @return mixed|object
     */
    public function getWeixinjspi($notify_url = null)
    {

        $this->weixinjspi_config = array_merge(['class'=>Weixinjspi::className()],$this->weixinjspi_config);
