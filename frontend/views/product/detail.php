...
<article class="paddingbtm">
  <div class="pd_publisher">
    ...
    <div class="pdp_right"><a href="javascript:;" class="iconfont icon-jia">关注</a></div>
  </div>
  ...
  <div class="pd_purchase">
   ...
   <div class="pdmai_right"><a href="javascript:;" class="add_cart" data-id=1>加入购物车</a><a href="javascript:;">立即购买</a></div>
  </div>
  ...
  <div class="pd_comment">
    ...
    <ul class="pdc_btm">
       <li>
         ...
         <div class="pdc_content">牛排很厚，味道不错，好评</div>
         <div class="pdc_reply">
           <p><i>Woman</i> <strong>回复@看不清的脸庞丶</strong>  喜欢吃的话别忘记了分享给朋友喔。 <br /><span>1月13日 19:59</span></p>
           <p><i>看不清的脸庞丶</i> <strong>回复@Woman</strong>  已经分享了，哈哈，他们都很喜欢呢，已经下单了吧。 <br /><span>1月13日 19:59</span></p>
         </div>
       </li>
       <li>
         ...
         <div class="pdc_content">店家发货及物流都超快，很赞！牛排也很不错，厚切的口感很好！日期都很新，很愉快的一次购物。</div>
       </li>
    </ul>
  </div>
</article>
...
<footer>
  <ul class="ab_rightbtn">
    <li class="blackbtn"><a href="javascript:;" class="iconfont icon-shouye">首页</a></li>
    ...
    <li class="blackbtn"><a href="javascript:;" class="iconfont icon-gouwuche">购物车<i></i></a></li>
    <li><a href="javascript:;">写评论</a></li>
  </ul>
</footer>
...
<script type="text/javascript" src="assets/shop/js/jquery-2.1.1.js"></script>
<script>
$(function (){ 
